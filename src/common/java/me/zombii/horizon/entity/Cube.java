...
//            body.setPhysicsRotation(rotation = Quaternion.DIRECTION_Z);
    ...
    static final Vector3 centre = new Vector3(-.5f, -.5f, -.5f);
...
//                tmpModelMatrix.idt();
                ...
                this.lastRenderPosition.set(tmpRenderPos);
                MatrixUtil.rotateAroundOrigin4(0, tmpModelMatrix, centre, rotation);
    ...
    public void setState(BlockState state) {
        ...
        if (this.state.get().getBlock().blockEntityId != null && zone != null) {
