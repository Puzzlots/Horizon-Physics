...
import finalforeach.cosmicreach.particles.GameParticleSystemRegistry;
...
public class PhysicBlockActionExplode implements IBlockAction {
    ...
    static final IDamageSource physicsSource = new IDamageSource() {
        @Override
    ...
    public void act(BlockEventArgs args) {
        ...
        GameParticleSystem system = GameParticleSystemRegistry.explosionParticleSystem.copy();
