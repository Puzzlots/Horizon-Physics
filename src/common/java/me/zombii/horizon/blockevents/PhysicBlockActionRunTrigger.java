...
public class PhysicBlockActionRunTrigger implements IBlockAction {
    ...
    public void act(BlockEventArgs args) {
        Zone zone = args.zone;
        IReadBlockPosition sourcePosition = args.blockPos;
        ...
        if (targetPosition != null) {
            ...
            if (!shouldQueue) {
                ...
                if (this.blockEventId == null) {
                    ...
                    targetEvents = (BlockEventTrigger[]) BlockEvents.INSTANCES.get(this.blockEventId).getTriggers(this.triggerId);
                }
            ...
            if (args instanceof SingleBlockEventArgs singleBlockEventArgs && xOff + yOff + zOff == 0) {
                ...
                if (shouldQueue) {
                    ...
                    ScheduledBlockTrigger queuedTrigger = ScheduledBlockTrigger.POOL.obtain();
